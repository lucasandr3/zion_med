          ...
          <div class="rounded-2xl border border-base-200 bg-white p-6 shadow-soft">
            ...
            <div class="mt-6 grid gap-4 sm:grid-cols-2">
              <div class="rounded-xl border border-base-200 bg-base-50 p-4">
                <div class="text-xs text-slate-500">Submissões pendentes</div>
          ...
          <div class="mt-5 space-y-3">
            <div class="rounded-xl border border-base-200 bg-white p-4">
              <div class="flex items-center justify-between text-xs">
                <span class="font-medium text-slate-700">Aprovação de submissão</span>
            ...
            <div class="rounded-xl border border-base-200 bg-white p-4">
              <div class="flex items-center justify-between text-xs">
                <span class="font-medium text-slate-700">Submissão pública</span>
      ...
      <div class="mt-10 grid gap-6 lg:grid-cols-3">
        ...
        <div class="rounded-2xl border border-base-200 bg-white p-6 shadow-sm">
          ...
          <ul class="mt-6 space-y-3 text-sm text-slate-700">
            <li class="flex gap-2"><span class="mt-1 h-2 w-2 rounded-full bg-accent-600"></span> Templates essenciais</li>
            <li class="flex gap-2"><span class="mt-1 h-2 w-2 rounded-full bg-accent-600"></span> Assinatura + PDF</li>
            <li class="flex gap-2"><span class="mt-1 h-2 w-2 rounded-full bg-accent-600"></span> Export CSV</li>
        ...
        <div class="rounded-2xl border border-accent-600/30 bg-accent-600 p-6 text-white shadow-glow">
          ...
          <ul class="mt-6 space-y-3 text-sm text-white/90">
            <li class="flex gap-2"><span class="mt-1 h-2 w-2 rounded-full bg-white/80"></span> Fluxo de aprovação</li>
            <li class="flex gap-2"><span class="mt-1 h-2 w-2 rounded-full bg-white/80"></span> Trilha de auditoria</li>
            <li class="flex gap-2"><span class="mt-1 h-2 w-2 rounded-full bg-white/80"></span> Templates por especialidade</li>
            <li class="flex gap-2"><span class="mt-1 h-2 w-2 rounded-full bg-white/80"></span> Integração com outros sistemas (API + webhooks)</li>
        ...
        <div class="rounded-2xl border border-base-200 bg-white p-6 shadow-sm">
          ...
          <ul class="mt-6 space-y-3 text-sm text-slate-700">
            <li class="flex gap-2"><span class="mt-1 h-2 w-2 rounded-full bg-accent-600"></span> Padronização multiunidade</li>
            <li class="flex gap-2"><span class="mt-1 h-2 w-2 rounded-full bg-accent-600"></span> Governança por setor</li>
            <li class="flex gap-2"><span class="mt-1 h-2 w-2 rounded-full bg-accent-600"></span> Integração com outros sistemas (API + webhooks)</li>
    ...
    <div class="mx-auto max-w-7xl px-4 py-16">
      ...
      <div class="mt-10 grid gap-6 lg:grid-cols-2">
        ...
        <details class="rounded-2xl border border-base-200 bg-base-50 p-6">
          ...
          <p class="mt-3 text-sm text-slate-600">
            Sim. Cada submissão gera protocolo e pode gerar PDF automático com assinatura e dados do formulário.
          </p>
        </details>
    ...
    <div class="mx-auto max-w-7xl px-4 py-16">
      <div class="grid gap-10 lg:grid-cols-2 lg:items-center">
        ...
        <div class="rounded-2xl bg-white p-6 text-slate-900 shadow-soft">
          ...
          <p class="mt-1 text-sm text-slate-600">Preencha para receber contato e agendar a demonstração.</p>
          ...
          <form class="mt-6 space-y-4" action="#" method="post">
            ...
            <div>
              ...
              <input class="mt-1 w-full rounded-lg border border-base-200 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-accent-600/30"
                     type="text" name="clinic" placeholder="Nome da clínica" required />
            </div>
            ...
            <div class="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input class="mt-1 w-full rounded-lg border border-base-200 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-accent-600/30"
                       type="email" name="email" placeholder="email@clinica.com" required />
              </div>
              <div>
                <label class="text-xs font-medium text-slate-700">WhatsApp</label>
                <input class="mt-1 w-full rounded-lg border border-base-200 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-accent-600/30"
                       type="tel" name="phone" placeholder="(00) 00000-0000" required />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea class="mt-1 w-full rounded-lg border border-base-200 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-accent-600/30"
                        name="message" rows="3" placeholder="Conte rapidamente seu cenário (unidades, volume, processos)."></textarea>
            </div>
