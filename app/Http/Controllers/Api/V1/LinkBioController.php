...
class LinkBioController extends Controller
{
        ...
        return response()->json([
            'data' => [
                'clinic' => [
                    ...
                    'form_public_theme' => $clinic->form_public_theme,
                    'form_accent_hex' => $clinic->form_accent_hex,
                    'hide_platform_branding' => (bool) ($clinic->hide_platform_branding ?? false),
    ...
    public function updateAparencia(Request $request): JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            'link_bio_extra.vet_exam_results_url' => ['nullable', 'string', 'url', 'max:500'],
            'link_bio_extra.vet_exam_results_label' => ['nullable', 'string', 'max:120'],
            'link_bio_extra.vet_exam_results_subtitle' => ['nullable', 'string', 'max:200'],
