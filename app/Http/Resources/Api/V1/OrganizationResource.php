...
class OrganizationResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'google_reviews_enabled' => (bool) ($this->google_reviews_enabled ?? false),
            'public_theme' => $this->public_theme,
            'accent_hex' => $this->accent_hex,
            'form_public_theme' => $this->form_public_theme,
            'form_accent_hex' => $this->form_accent_hex,
            'hide_platform_branding' => (bool) ($this->hide_platform_branding ?? false),
