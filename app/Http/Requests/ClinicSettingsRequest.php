...
class ClinicSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'address_data.cep' => ['nullable', 'string', 'max:8', 'regex:/^\d{8}$/'],
            'address_data.logradouro' => ['nullable', 'string', 'max:255'],
            'address_data.numero' => ['nullable', 'string', 'max:20'],
            'address_data.complemento' => ['nullable', 'string', 'max:255'],
            'address_data.bairro' => ['nullable', 'string', 'max:255'],
            'address_data.cidade' => ['nullable', 'string', 'max:255'],
            'address_data.uf' => ['nullable', 'string', 'size:2', 'regex:/^[A-Za-z]{2}$/'],
            ...
            'form_public_theme'  => ['nullable', 'string', Rule::in(array_merge([''], app(ThemeService::class)->publicThemeKeysForValidation()))],
